...
function menu(hoolni_ner, une, turul) {
    const dinnerplate = { name: hoolni_ner, price: une, category: turul }
    return dinnerplate;
}
console.log(menu("Aduuni mah", "$1200", "ulamjlalt"))

// function gamegenerator(ner, rating, turul) {
//     const game = { name: ner, rating: rating, turul: turul }
//     return game
// }
// console.log(gamegenerator("Valo", 4, "fps"))
...
burger.discount = function(special) {
    if (special == "teacher" || special == "students") {
        console.log(this.price * 0.75)
    } else {
        console.log(this.price * 0.9)
    }
}
burger.discount("uugna")