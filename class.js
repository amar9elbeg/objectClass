...
for (let k = 0; k < programming.languages.length; k++){
...
myPenguin.chrip = function(input) {
  console.log("CHIRP CHIRP!" + input)
  
}
myPenguin.chrip("jeje")
...
// function computer(gpu, cpu, ram, storage,){
//   const pc = {gpu: gpu, cpu: cpu, ram: ram, storage: storage}
//   return pc
// }
// const pc = computer("MSI GeForce RTX 3080", "10th-gen Intel Core i9", "128GB", "3TB HDD + 2TB SSD");
// console.log(pc)
function menu(hoolni_ner, une, turul){
  const dinnerplate = { name: hoolni_ner, price: une, cataglory: turul}
  return dinnerplate
}
console.log(menu("tsuivan", "1000$", "huurag"))
